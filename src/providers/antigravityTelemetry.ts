...
function streamResult(stdout: string): Record<string, unknown> | null {
...
export function extractAntigravityRunTelemetry(stdout: string): RunTelemetry | undefined {
  const result = streamResult(stdout);
