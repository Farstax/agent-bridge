...
→ ordinary Run / continuation → provider agent + AGENTS.md + Skills + tools
...
fallback, delivery, and recovery. The provider owns its native session,
protocol, tools, and subagents. Repository-local instructions and Skills own
