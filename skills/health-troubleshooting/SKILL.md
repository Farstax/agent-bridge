...
description: Use when an Agent Bridge health observation needs evidence-led diagnosis, authorised remediation, and verification
---

# Health troubleshooting

Investigate health observations inside the authority already granted to the current Run. This Skill does not grant permission to restart services, deploy, change configuration, mutate repositories, or take any other consequential action.
...
Return a compact report with: observation, evidence, inference/root cause, action taken or recommended, verification, and any remaining risk. Do not expose hidden reasoning, credentials, or raw protocol payloads.
